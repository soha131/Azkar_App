...
public class EveningAzkarActivity extends AppCompatActivity {
    ...
    private List<String> allAzkar; // All Evening Azkar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EveningAzkarActivity.this, MenuActivity.class);
    ...
    private void initializeAzkar() {
        ...
        allAzkar.add("أعوذ بكلمات الله التامات من شر ما خلق (3 مرات)");
        allAzkar.add("اللهم بك أمسينا وبك أصبحنا وبك نحيا وبك نموت وإليك المصير.");
        allAzkar.add("أمسينا وأمسى الملك لله والحمد لله...");
        allAzkar.add("اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك...");
        allAzkar.add("اللهم إني أمسيت أشهدك وأشهد حملة عرشك...");
        allAzkar.add("اللهم إني أعوذ بك من الكفر والفقر...");
        allAzkar.add("حسبي الله لا إله إلا هو عليه توكلت وهو رب العرش العظيم (7 مرات)");
        allAzkar.add("اللهم إني أعوذ بك من الهم والحزن والعجز والكسل...");
        allAzkar.add("اللهم عافني في بدني، اللهم عافني في سمعي...");
        allAzkar.add("سبحان الله وبحمده (100 مرة)");
    }
